...
fun createTvShow(): MovieUi {
    ...
    tv.createdAt = Date(123)
    return tv
}

fun createMovie(): MovieUi {
    val movie =
        Movie(
            originalTitle = "Cruella",
            posterPath = "/A0knvX7rlwTyZSKj8H5NiARb45.jpg",
    ...
    movie.createdAt = Date(123)

    return movie
}

fun expectedFavoriteMovieResult(): List<FavoriteAndMovie> {
    return listOf(
        createFavoriteMovie(),
        createFavoriteMovie(),
        createFavoriteMovie(),
...
fun expectedFavoriteTvShowResult(): List<FavoriteAndMovie> {
    return listOf(
        createFavoriteTvShow(),
        createFavoriteTvShow(),
        createFavoriteTvShow(),
        createFavoriteTvShow()
    )
...
fun createFavoriteMovie(): FavoriteAndMovie {
    ...
    movie.createdAt = Date(123)
    return FavoriteAndMovie(
        Favorite(movieId = movie.id, favoriteId = 1, movieType = movie.type, createdAt = Date(123)),
        movie
    )
}

fun createFavoriteMovieAsFlow(): Flow<FavoriteAndMovie> = flow {
    emit(createFavoriteMovie())
}

fun createFavoriteTvShow(): FavoriteAndMovie {
...
fun createFavoriteTvShowAsFlow(): Flow<FavoriteAndMovie> = flow {
    emit(createFavoriteTvShow())
}